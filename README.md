...
1. **Clone the Repository:**
   ...
   ```bash
   git clone https://github.com/rudrapratapp07/To-Do-List.git
   ```
...
The TO-DOIT App is deployed and accessible online. You can use the following link to access the application: [TO-DOIT](https://to-do-list-kohl-rho-27.vercel.app)
